...
Gem::Specification.new do |spec|
  ...
  spec.homepage = "https://github.com/jobleeyoui/slanger"
  spec.license = "MIT"
  spec.required_ruby_version = Gem::Requirement.new(">= 2.6.3")

  spec.metadata["homepage_uri"] = spec.homepage
  spec.metadata["source_code_uri"] = "https://github.com/jobleeyoui/slanger/archive/v0.7.0.zip"
  spec.metadata["changelog_uri"] = "https://github.com/jobleeyoui/slanger/releases"
